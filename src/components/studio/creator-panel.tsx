  ...
  return (
    <article className="glass flex flex-col gap-4 p-5">
      <header className="flex items-start justify-between gap-3">
        ...
        <span className="chip shrink-0 border-border bg-surface-2/60 capitalize text-muted">
          {stage.replace(/_/g, " ")}
        </span>
      </header>
      ...
      <div className="rounded-xl border border-border/60 bg-surface-2/30">
        <button
          ...
          className="flex w-full items-center justify-between gap-2 px-3.5 py-2.5 text-left outline-none focus-visible:ring-2 focus-visible:ring-primary/60"
        >
