...
export default async function ScriptsPage({
  ...
  return (
    <>
      <PageHeader title="Scripts" subtitle="Drafted scripts awaiting review and guardrail checks">
        <BrandSelector
        ...
        <div className="flex flex-col gap-3">
          {withScript.map((item) => {
            ...
            return (
              <details
                key={item.id}
                className="glass group overflow-hidden p-0 [&_summary::-webkit-details-marker]:hidden"
              >
                <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-5 py-4 outline-none transition-colors hover:bg-surface-2/40 focus-visible:ring-2 focus-visible:ring-primary/60">
