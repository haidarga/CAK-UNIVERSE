      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-mutedText">
            Upload gambar/screenshot atau video konten (punya kompetitor, referensi viral, dll) — AI baca
            visualnya dan terjemahin jadi creative direction (hook, gaya visual, pacing, shot breakdown,
            cara adaptasi). Salin hasilnya, pakein di Arahan pas generate naskah.
          </p>
        </div>
      </div>
